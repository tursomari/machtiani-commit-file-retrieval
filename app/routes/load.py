...
async def handle_load(
    ...
    if lock_file_exists:
        ...
        raise HTTPException(status_code=423, detail=f"Operation is locked for project '{project}'. Please try again later. Lock has been active for {elapsed_hours} hours and {elapsed_minutes} minutes.")
